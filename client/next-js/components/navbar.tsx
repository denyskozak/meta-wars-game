            ...
            <NavbarContent className="basis-1/5 sm:basis-full" justify="start">
                <NavbarBrand as="li" className="gap-3 max-w-fit">
                    <NextLink className="flex justify-start items-center gap-4" href="/">
                        ...
                        <p className="font-bold text-inherit text-center">Meta Wars
                            <br/>
                    ...
                    {account ? (
                        <>
                            {account && (
                                ...
                                >
                                    <span
                                        className="absolute inset-0 bg-gradient-to-r from-orange-500 via-yellow-500 to-purple-500 animate-pulse opacity-100 group-hover:opacity-100 blur-md"/>
